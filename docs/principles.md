...
| **[GUIDE]** | Open Platform：视频生成指南（H3 工作流） | *Video Generation guides*（英文） | 产品指南 | [打开原文](https://platform.minimax.io/docs/guides/video-generation) |
...
| 4 | 把 Turbo / FastH3 蒸馏当成「同一原理的无损加速」 | 多为社区 / 第三方推理加速权衡；勿与官方一手材料混为一谈 | [BLOG][OSS] |
